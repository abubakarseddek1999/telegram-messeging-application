            ...
            <div className="mb-5 flex justify-between items-center">
                ...
                <div className='item-end'>
                    ...
                    {/* <div className='flex justify-end'>
                        <p className='text-xs bg-blue-500 rounded-full text-white p-1 w-6 text-center'>2</p>
                    </div> */}
                </div>
            </div>
                    ...
                    <div key={chat.id} className="mb-8 flex justify-between items-center">
                        <div className='flex justify-start items-center'>
                            ...
                            <div>
                                ...
                                <p className=''>i am good learner</p>
                            </div>
                        </div>
            ...
            {page < totalPages && (
                <div className='flex justify-center'>
                    <button
                        ...
                        className="mt-4 btn-block bg-blue-500 text-white p-2 rounded">
                        More..
                    </button>
                </div>
            )}
